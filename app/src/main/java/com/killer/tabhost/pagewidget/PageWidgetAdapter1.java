...
//		System.out.println("position="+position);
		if (position == 0) {
			setFirstPage(layout, position);
		} else if (position == 1) {
			setSecondPage(layout, position);
		} else if (position == 2) {
			setThirdPage(layout, position);
		} else if (position == 3) {
			setFourthPage(layout, position);
		} else if (position == 4) {
			setFifthPage(layout, position);
		} else if (position == 5) {
			setSixthPage(layout, position);
		} else if (position == 6) {
			setSeventhPage(layout, position);
		}
		
		return layout;
	}
	
	private void setFirstPage(ViewGroup group, int position) {
	...
	private void setSecondPage(ViewGroup group, int position) {;
	...
	private void setThirdPage(ViewGroup group, int position) {;
		tv_title.setVisibility(View.GONE);
		tv_author.setVisibility(View.GONE);
	...
	private void setFourthPage(ViewGroup group, int position) {;
		tv_title.setVisibility(View.GONE);
		tv_author.setVisibility(View.GONE);
	...
	private void setFifthPage(ViewGroup group, int position) {;
		tv_title.setVisibility(View.GONE);
		tv_author.setVisibility(View.GONE);
		tv_content_up.setVisibility(View.GONE);
	...
	private void setSixthPage(ViewGroup group, int position) {;
		tv_title.setVisibility(View.GONE);
		tv_author.setVisibility(View.GONE);
	...
	private void setSeventhPage(ViewGroup group, int position) {;
		tv_title.setVisibility(View.GONE);
		tv_author.setVisibility(View.GONE);
