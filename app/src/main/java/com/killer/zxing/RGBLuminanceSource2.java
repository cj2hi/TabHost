...
public final class RGBLuminanceSource2 extends LuminanceSource {

    private final byte[] luminances;

    public RGBLuminanceSource2(Bitmap bitmap) {
    ...
    public RGBLuminanceSource2(String path) throws FileNotFoundException {
